...
import dev.kilua.dom.api.RenderingContext
...
public open external class Int8Array : ArrayBufferView, JsAny {
    ...
    fun set(array: Int8Array, offset: Int)
...
public open external class Int16Array : ArrayBufferView, JsAny {
    ...
    override val byteOffset: Int
    override val byteLength: Int
    fun set(array: Int16Array, offset: Int)
    fun set(array: JsArray<JsNumber>, offset: Int)
...
public open external class Int32Array : ArrayBufferView, JsAny {
    ...
    override val byteOffset: Int
    override val byteLength: Int
    fun set(array: Int32Array, offset: Int)
    fun set(array: JsArray<JsNumber>, offset: Int)
...
public open external class Uint32Array : ArrayBufferView, JsAny {
    ...
    override val byteOffset: Int
    override val byteLength: Int
    fun set(array: Uint32Array, offset: Int)
    fun set(array: JsArray<JsNumber>, offset: Int)
...
public open external class Float64Array : ArrayBufferView, JsAny {
    ...
    override val byteOffset: Int
    override val byteLength: Int
    fun set(array: Float64Array, offset: Int)
    fun set(array: JsArray<JsNumber>, offset: Int)
...
public open external class DataView(
    ...
    fun getUint16(byteOffset: Int, littleEndian: Boolean): Short
    fun getInt32(byteOffset: Int, littleEndian: Boolean): Int
    fun getUint32(byteOffset: Int, littleEndian: Boolean): Int
    ...
    fun setUint16(byteOffset: Int, value: Short, littleEndian: Boolean)
    fun setInt32(byteOffset: Int, value: Int, littleEndian: Boolean)
    fun setUint32(byteOffset: Int, value: Int, littleEndian: Boolean)
