...
Base SSR (server-side-rendering) is implemented for Ktor, Spring Boot and Javalin servers, support for other 
servers will follow.
...
### Current limitations:
- Only Ktor, Spring Boot and Javalin servers are supported out of the box.
